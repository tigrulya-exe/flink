...
import org.apache.flink.streaming.api.connector.source.enumerator.NoOpSplitEnumerator;
...
/** todo. */
public class FromElementsSourceOld<T> implements Source<T, FromElementsSplit, NoOpEnumState> {
    ...
    public FromElementsSourceOld(TypeSerializer<T> serializer, Collection<T> collection)
            throws IOException {
    ...
    public SourceReader<T, FromElementsSplit> createReader(SourceReaderContext readerContext)
            throws Exception {
        return new FromElementsSourceReader<>(serializer, elementsSerialized, elementsCount);
    }
    ...
    public SplitEnumerator<FromElementsSplit, NoOpEnumState> createEnumerator(
        ...
        return new NoOpSplitEnumerator<>();
    }
